...
public class Test8 {
    ...
    @BeforeClass
    @Parameters({"webdriverPath", "nodeUrl"})
    public void setUp(String webdriverPath, String nodeUrl) throws MalformedURLException {
        System.setProperty("webdriver.edge.driver", webdriverPath);

        DesiredCapabilities cap = new DesiredCapabilities();
        cap.setBrowserName("MicrosoftEdge");
        cap.setPlatform(org.openqa.selenium.Platform.WINDOWS); // Use WINDOWS for any version of Windows

        // Initialize the RemoteWebDriver with EdgeOptions
        EdgeOptions options = new EdgeOptions();
        options.merge(cap); // Merge EdgeOptions with DesiredCapabilities
...
////													
										        ...
										        driver.switchTo().defaultContent();
										        System.out.println("final submit 58");
